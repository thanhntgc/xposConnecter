...
class SM_XReport_Block_Adminhtml_Dashboard_Chart extends Mage_Adminhtml_Block_Dashboard_Graph {
    public function __construct() {
        ...
        $this->setDataHelperName('xreport/dashboard_order');
    ...
    public function getDataSalesChart($period, $filter = 0, $customDate = false, $getNgChart = true) {
//        return true;
        $this->getDataHelper()->setParam('period', $period);

        $customStart = '';
        $customEnd = '';
        if($customDate && $period == 'custom'){
            $cDdate = explode(':',$customDate);
            $customStart = Mage::app()->getLocale()->storeDate(null, $cDdate[0], null, 'YYYY-MM-dd');
            $customEnd = Mage::app()->getLocale()->storeDate(null, $cDdate[1], null, 'YYYY-MM-dd');
        ...
        $this->getDataHelper()->setParam('customStart', $customStart);
        $this->getDataHelper()->setParam('customEnd', $customEnd);
